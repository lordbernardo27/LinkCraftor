...
def connect_domain(payload: ConnectDomainPayload):
    """Canonical Connect Domain entry point."""
    return run_linking_target_pipeline(payload)


def run_linking_target_pipeline(payload: ConnectDomainPayload):
    """Delegate execution to Connect Domain Pipeline 1."""
    from backend.server.pipelines.connect_domain.linking_target_pipeline import (
        run_linking_target_pipeline as execute_linking_target_pipeline,
    )

    return execute_linking_target_pipeline(payload)

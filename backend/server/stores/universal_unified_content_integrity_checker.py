...
def check_unified_content_integrity_v1(
    *,
    ...
    return {
        ...
        "message": "Stored Universal Unified Content Document matches extracted content." if exact_match else "Stored Universal Unified Content Document differs from extracted content.",
    }

...
def build_ucd_from_validated_article_v1(
    *,
    ...
    if validation_result and not validation_result.get("eligible_for_unified_content_document", False):
        raise ValueError(
            "Article is not eligible for Unified Content Document creation."
        )
    ...
    document = from_crawled_web_page_v1(
        ...
        metadata={
            **(metadata or {}),
            "ucd_bridge_version": "validated_article_ucd_bridge_v1",
...
def upsert_ucd_from_validated_article_v1(
    *,
    ...
    upsert_unified_content_document_v1(document)
